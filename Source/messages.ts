...
export const selectOrganizationForEnhancedIntelliSense =
...
export const selectOrganizationPlaceholder =
	"Select Azure DevOps organization associated with the %s repository";
export const signInLabel = "Sign In";
export const signInWithADifferentAccountLabel =
	"Sign in with a different account";
export const changeTenantLabel = "Change active tenant";
export const unableToAccessOrganization =
	'Unable to access the "%s" organization. Make sure you\'re signed into the right Microsoft account or using the right tenant.';
