export class Messages {
	public static acquireAccessTokenFailed: string =
	...
	public static noAvailableFileNames: string =
		"No available filenames found.";
	...
	public static selectOrganizationForEnhancedIntelliSense: string =
	...
	public static selectOrganizationPlaceholder: string =
		"Select Azure DevOps organization associated with the %s repository";
	public static selectPipelineTemplate: string =
	...
	public static unableToAccessOrganization: string =
	...
	public static signInForEnhancedIntelliSense =
		"Sign in to Azure for enhanced Azure Pipelines IntelliSense";
	public static userEligibleForEnahanced1ESPTIntellisense =
		"Enable 1ESPT Schema in Azure Pipelines Extension settings for enhanced Intellisense";
	public static notUsing1ESPTSchemaAsUserNotSignedInMessage =
