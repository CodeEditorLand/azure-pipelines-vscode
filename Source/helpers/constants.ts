...
export class CommandNames {
	...
	static DisplayCurrentSchemaFile: string =
		CommandNames.CommandPrefix + "DisplayCurrentSchemaFile";
	static LoadLatestTaskSchema: string =
		CommandNames.CommandPrefix + "LoadLatestTaskSchema";
...
export class LogMessages {
	static AccountRequiredToDownloadTasks: string =
		"Account name is required to download tasks. Please set azure-pipelines.account setting.";
	static PatRequiredToDownloadTasks: string =
		"PAT is required to download tasks. Please set using Signin command.";
}
