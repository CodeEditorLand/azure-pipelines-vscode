import type { RequestPrepareOptions } from "@azure/ms-rest-js";
...
import type { Organization } from "../../model/models";
...
export class OrganizationsClient {
	...
	public async sendRequest<T>(
		...
		if (requestPrepareOptions.headers) {
			requestPrepareOptions.headers["X-TFS-Session"] =
				telemetryHelper.getJourneyId();
		} else {
			requestPrepareOptions.headers = {
