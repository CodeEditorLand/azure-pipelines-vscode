...
export class AzureResourceClient {
	...
	constructor(credentials: TokenCredentialsBase, subscriptionId: string) {
		this.azureRmClient = new ResourceManagementClient(
			credentials,
			subscriptionId
		);
	}
	...
	public async getResourceList(
		...
		let resourceListResult: ResourceManagementModels.ResourceListResult =
	...
	public async getResource(
		...
		let resource: ResourceManagementModels.GenericResource =
