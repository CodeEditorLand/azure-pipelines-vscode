...
async function analyzeRepo(repoUri: URI): Promise<{
	isNodeApplication: boolean;
	isFunctionApplication: boolean;
	isPythonApplication: boolean;
	isDotnetApplication: boolean;
}> {
	...
	const files = contents
		.filter((file) => file[1] !== vscode.FileType.Directory)
		.map((file) => file[0]);
...
const nodeTemplates: Array<PipelineTemplate> = [
	{
		...
		path: path.join(
			__dirname,
			"configure/templates/nodejsWindowsWebApp.yml",
		),
		language: "node",
		target: {
	...
	},
	{
		...
		path: path.join(
			__dirname,
			"configure/templates/nodejsWindowsWebAppAngular.yml",
		),
		language: "node",
		target: {
			type: TargetResourceType.WebApp,
	...
	},
	{
		...
		path: path.join(
			__dirname,
			"configure/templates/nodejsWindowsWebAppGulp.yml",
		),
		language: "node",
		target: {
			type: TargetResourceType.WebApp,
	...
	},
	{
		...
		path: path.join(
			__dirname,
			"configure/templates/nodejsWindowsWebAppGrunt.yml",
		),
		language: "node",
		target: {
			type: TargetResourceType.WebApp,
	...
	},
	{
		...
		path: path.join(
			__dirname,
			"configure/templates/nodejsWindowsWebAppWebpack.yml",
		),
		language: "node",
		target: {
			type: TargetResourceType.WebApp,
...
const dotnetTemplates: Array<PipelineTemplate> = [
	{
		...
		path: path.join(
			__dirname,
			"configure/templates/dotnetWindowsWebApp.yml",
		),
		language: "dotnet",
		target: {
			type: TargetResourceType.WebApp,
...
const functionTemplates: Array<PipelineTemplate> = [
	{
		...
		path: path.join(
			__dirname,
			"configure/templates/pythonLinuxFunctionApp.yml",
		),
		language: "python",
		target: {
			type: TargetResourceType.WebApp,
	...
	},
	{
		...
		path: path.join(
			__dirname,
			"configure/templates/nodejsLinuxFunctionApp.yml",
		),
		language: "node",
		target: {
			type: TargetResourceType.WebApp,
	...
	},
	{
		...
		path: path.join(
			__dirname,
			"configure/templates/dotnetWindowsFunctionApp.yml",
		),
		language: "dotnet",
		target: {
			type: TargetResourceType.WebApp,
